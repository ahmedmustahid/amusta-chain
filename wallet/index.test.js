...
describe('Wallet',()=>{
    ...
    describe('Creating a transaction',() =>{
        ...
        describe('and doing the same transaction',() =>{
            ...
            it('doubles the sent amount subtracted from the sender wallet', () =>{
    ...
    describe('calculating balance ',()=>{
        ...
        it('calculates balance for blockchain transaction matching the recipient',()=>{
            expect(wallet.calculateBalance(bc)).toEqual(INITIAL_BALANCE + (addBalance * repeatAdd));
        });

        it('calculates balance for blockchain transaction matching the sender',()=>{
        ...
        describe('and the recipient conducts a transaction',()=>{
                ...
                describe('sender sends another transaction to the recipient',()=>{
                    ...
                    it('calculates the recipient balance only using the most recent one',()=>{
